...
<div class="form">
		<h2 style="color:6CA870	;"> Update Success!! </h2>

<h2 style="text-align:center; font-family: Arial Rounded MT Bold; color:#8C001A"> Total Number of Assets: <s:property value="%{getSearchUpdateBean().size()}"/> </h2>


<s:iterator value = "searchUpdateBean" >
<table>
<tr>
